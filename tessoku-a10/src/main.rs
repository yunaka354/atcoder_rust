...
fn main() {
    ...
    let mut max_from_left = vec![0; n];
    let mut max_from_right = vec![0; n];
    ...
    max_from_left.insert(0, 0); // adding 0 to the left
    max_from_right.push(0); // adding 0 to right
    ...
    for _ in 0..d {
        ...
        println!("{}", max(max_from_left[l-1], max_from_right[r]));
    }
}