...
fn find_term_exceeds(a: f64, x: f64) -> u32 {
    let n = ((x / a).log2() + 1.0).ceil() as u32;
    n
}
...
fn main() {
    ...
    for i in 1..=n {
        let term = find_term_exceeds(i as f64, k as f64);
        println!("{}", term);
        let y = (2 as u32).pow(term-1);
        println!("i={} denomi={}", i, n*y as usize);
    }
}