...
fn main() {
    ...
    let mut waiting: BinaryHeap<Reverse<(usize, usize)>> = BinaryHeap::new();
        ...
        loop {
            ...
            match waiting.peek() {
                ...
                Some(Reverse(person)) => {
                    ...
                    let Reverse(p) = waiting.pop().unwrap();
                    que.push(Reverse(p.1));
                }
            }
        }
        match que.pop() {
