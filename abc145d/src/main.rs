...
impl Combinations {
    fn new(max_n: usize) -> Self {
        let mut fact = vec![Mint::new(1); max_n + 1];
        let mut inv_fact = vec![Mint::new(1); max_n + 1];
        ...
        Combinations { fact, inv_fact }
    }

    fn ncr(&self, n: usize, r: usize) -> Mint {
        if r > n {
            return Mint::new(0);
        }
...
fn main() {
    ...
    let comb = Combinations::new((x + y) as usize);

    println!("{}", comb.ncr((x + y) as usize, x as usize));
}
