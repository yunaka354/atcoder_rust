...
fn main() {
    ...
    let mut ans = 0;
    if n >= 1000 {ans += n-999};
    if n >= 1000_000 {ans += n-999_999};
    if n >= 1000_000_000 {ans += n-999_999_999};
    if n >= 1000_000_000_000 {ans += n-999_999_999_999};
    if n >= 1000_000_000_000_000 {ans += n-999_999_999_999_999};
