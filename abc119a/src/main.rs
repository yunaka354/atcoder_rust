...
fn main() {
    ...
    let mut year = 0;
    year += s[0].to_digit(10).unwrap();
    year *= 10;
    year += s[1].to_digit(10).unwrap();
    year *= 10;
    year += s[2].to_digit(10).unwrap();
    year *= 10;
    year += s[3].to_digit(10).unwrap();
    
    let mut month = 0;
    month += s[5].to_digit(10).unwrap();
    month *= 10;
    month += s[6].to_digit(10).unwrap();
