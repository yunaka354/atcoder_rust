...
fn main() {
    ...
    set.insert(format!("{}{}{}", s[0], s[1], s[2]));
    set.insert(format!("{}{}{}", s[0], s[2], s[1]));
    set.insert(format!("{}{}{}", s[1], s[0], s[2]));
    set.insert(format!("{}{}{}", s[1], s[2], s[0]));
    set.insert(format!("{}{}{}", s[2], s[0], s[1]));
    set.insert(format!("{}{}{}", s[2], s[1], s[0]));
